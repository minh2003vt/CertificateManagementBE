    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AllotedSlots", x => new { x.SlotId, x.ClassId });
                    table.ForeignKey(
                        name: "FK_AllotedSlots_Slots_SlotId",
                        column: x => x.SlotId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SignDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "DATEADD(hour, 7, GETUTCDATE())"),
                    ...
                    IncludesRelearn = table.Column<bool>(type: "bit", nullable: false),
                    RelearnSubjects = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TemplateFile = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    LastUpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "DATEADD(hour, 7, GETUTCDATE())")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    ClassId = table.Column<int>(type: "int", nullable: false),
                    TraineeAssignationId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StartDateTime = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "DATEADD(hour, 7, GETUTCDATE())"),
                    EndDateTime = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "DATEADD(hour, 7, GETUTCDATE())"),
                    CreatedByUserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "DATEADD(hour, 7, GETUTCDATE())"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DecisionCode = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    Title = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Content = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    IssueDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "DATEADD(hour, 7, GETUTCDATE())"),
                    IssuedByUserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    CertificateId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    DecisionTemplateId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    SignDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "DATEADD(hour, 7, GETUTCDATE())"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ExternalCertificateId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CertificateCode = table.Column<string>(type: "nvarchar(450)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GenerateDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "DATEADD(hour, 7, GETUTCDATE())"),
                    StartDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "DATEADD(hour, 7, GETUTCDATE())"),
                    EndDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "DATEADD(hour, 7, GETUTCDATE())"),
                    Content = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequestDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "DATEADD(hour, 7, GETUTCDATE())"),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Notes = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Status = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ApprovedByUserId = table.Column<string>(type: "nvarchar(450)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SessionId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    LoginTime = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "DATEADD(hour, 7, GETUTCDATE())"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AssignDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "DATEADD(hour, 7, GETUTCDATE())"),
                    ApprovedByUserId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    ApprovalDate = table.Column<DateTime>(type: "datetime2", nullable: true, defaultValueSql: "DATEADD(hour, 7, GETUTCDATE())"),
                    RequestId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    SubjectId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    Notes = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    AssignmentScore = table.Column<double>(type: "float", nullable: false),
                    FinalExamScore = table.Column<double>(type: "float", nullable: false),
                    FinalResitScore = table.Column<double>(type: "float", nullable: true),
                    ...
                    EvaluationDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "DATEADD(hour, 7, GETUTCDATE())"),
                    UpdateDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "DATEADD(hour, 7, GETUTCDATE())")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExternalCertificates_VerifiedByUserId",
                table: "ExternalCertificates",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_AllotedSlots_Classes_ClassId",
                table: "AllotedSlots",
                column: "ClassId",
                principalTable: "Classes",
                principalColumn: "ClassId",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_ClassTraineeAssignations_TraineeAssignations_TraineeAssignationId",
                table: "ClassTraineeAssignations",
                column: "TraineeAssignationId",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_ExternalCertificates_Users_VerifiedByUserId",
                table: "ExternalCertificates",
                column: "VerifiedByUserId",
                principalTable: "Users",
                principalColumn: "UserId",
